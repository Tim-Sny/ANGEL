    ...
    public partial class PointsPanel : UserControl
    {
        ...
        private void textBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (T[0] >= 0 && T[1] >= 0 && T[2] >= 0)
            {
                ...
                //Обновление массива...
                cSchool.Activity[T[0]].Growth[T[1]][T[2]] = null;
                cSchool.Activity[T[0]].Growth[T[1]][T[2]] = iValues;

                //Обновление базы...
                var db = new DBEntities();
                db.sp_xActivityCharacterN_Modify(T[0], T[1], T[2], cFunc.ArrToStr(cSchool.Activity[T[0]].Growth[T[1]][T[2]]));

                float _StatAvgSum = cSchool.Activity[T[0]].GetGrowthAvgSum(T[1], T[2]);
                float _StatMinSum = cSchool.Activity[T[0]].GetGrowthMinSum(T[1], T[2]);
                float _StatMaxSum = cSchool.Activity[T[0]].GetGrowthMaxSum(T[1], T[2]);

                float _StatAvg = cSchool.Activity[T[0]].GetGrowthAvg(T[1], T[2]);
        ...
        {
            //int[] T = (int[])Tag;
            //lTR.Text = cFunc.ArrToStr(cSchool.EngadeInActivity(T[2], T[0], null));
        }
    }
}
